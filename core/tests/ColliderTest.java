...
public class ColliderTest extends GdxTest {
    ...
    public void testCollide() {
        ...
        cube1.setWorldPosition(new WorldPosition(1,1,1));
        cube2.setWorldPosition(new WorldPosition(1.5f,1,1));
        cube3.setWorldPosition(new WorldPosition(2f,1,1));
        cube4.setWorldPosition(new WorldPosition(2.1f,1,1));
        Assert.assertTrue(collider.collide(cube1,cube2));
        Assert.assertFalse(collider.collide(cube1,cube3));
